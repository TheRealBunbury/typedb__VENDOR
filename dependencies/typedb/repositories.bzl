...
def typedb_dependencies():
    git_repository(
        ...
        commit = "b0ebf3489638774277dd3af35862c09895a08dd0",  # sync-marker: do not remove this comment, this is used for sync-dependencies by @typedb_dependencies
    )
...
def typedb_protocol():
    git_repository(
        ...
        commit = "8e7cc266a36945f7b0f923605d05186c041e3f77",  # sync-marker: do not remove this comment, this is used for sync-dependencies by @typedb_protocol
    )
